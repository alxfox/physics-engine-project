#ifndef GP_ENGINE_OBJECTS_TRIGGER_H
#define GP_ENGINE_OBJECTS_TRIGGER_H
...
public:
	Trigger(float mass = 1, const Vector3f &position = Vector3f::Zero(), const Vector3f &size = Vector3f::Ones(),
